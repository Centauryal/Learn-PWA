        ...
        registration.pushManager
          .subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array(
              "BAGew-KfjcFRNiHGKB8jJ9YZbOdk1Pu-MnlFdWI4T5t7edbkBG4WjTzRLnzYzLvL2jEUGCN-62qMM7Hhg9APB8Q"
            )
          })
    ...
    elem.innerHTML = `
      ...
      <div class="detail-logo-info">
        ...
        <a class="waves-effect waves-light btn btn-team">
          <i class="iconify left btn-favorite" data-icon="fa-heart" onclick="toggleFav(teamId)"></i>Favorite
        </a>
      </div>
    `;
